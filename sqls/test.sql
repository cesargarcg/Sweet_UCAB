...
CREATE TABLE Zona_Almacen (
	...
	CONSTRAINT almacena FOREIGN KEY (FK_P_ID) REFERENCES Producto (P_ID),
...
CREATE TABLE Zona_Pasillo (
	...
	CONSTRAINT conserva FOREIGN KEY (FK_P_ID) REFERENCES Producto (P_ID),
...
CREATE TABLE Detalle_Pedido (
	...
	FK_PE_Online_ID		INTEGER,
	FK_PE_Fisico_ID		INTEGER,
	FK_PF_ID			INTEGER,
	FK_TI_ID			NUMERIC(10),
...
CREATE TABLE Estatus_Pedido_Online (
	ES_PE_ID		SERIAL,
	FK_PE_ID		INTEGER			NOT NULL,
	FK_ES_Clave		INTEGER			NOT NULL,
