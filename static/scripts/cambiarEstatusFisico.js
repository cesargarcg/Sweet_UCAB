...
let users = []
userForm['numero'].value = updata.pe_numero_orden
...
userForm.addEventListener('submit', async e => {
    ...
    const response = await fetch(`/api/estatusPedidosFisicos/${updata.pe_id}`, {
        method: 'PUT',
        headers: {
    ...
    window.location.replace("http://localhost:5000/pedidosFisicosCreados");
